  var calendarLinks = function(event_title, startDateTimeString, endDateTimeString, event_address, event_description) {
      ...
      var calendarGenerators = {
        google: function(event) {
          ...
          return '<i class="fa fa-google"></i> <a href="' +
            href + '" target="_blank">Google Calendar</a>';
        },
        ...
        yahoo: function(event) {
          ...
          return '<i class="fa fa-yahoo"></i> <a href="' +
            href + '" target="_blank">Yahoo! Calendar</a>';
        },
        ...
        ics: function(event, calendarName) {
          ...
          return '<i class="fa fa-calendar-plu-o"></i> <a href="' +
            href + '" target="_blank">' + calendarName + ' Calendar</a>';
        },

        ical: function(event) {
          return this.ics(event, 'iCal');
        },

        outlook: function(event) {
          return this.ics(event, 'Outlook');
        }
      };
